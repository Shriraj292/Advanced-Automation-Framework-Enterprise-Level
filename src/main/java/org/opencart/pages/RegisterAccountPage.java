...
public final class RegisterAccountPage extends BasePage{
    ...
    private static final By radio_No = By.xpath("//div[@class='form-group']/descendant::input[@type='radio' and @value='0']");
    private static final By radio_Yes = By.xpath("//div[@class='form-group']/descendant::input[@type='radio' and @value='1']");
    ...
    public RegisterAccountPage enterRegistrationDetailsAndContinue(String firstName, String lastName, String email, String telephone,
                                         String password){
    ...
    public RegisterAccountPage verifyRegistrationStatus(){
        String successMessage = ExplicitWaitFactory.explicitlyWaitFor(WaitStrategies.VISIBILITY_OF,
                text_SuccessMessage).getText();
